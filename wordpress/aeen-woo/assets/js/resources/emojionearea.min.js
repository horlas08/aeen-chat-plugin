...
window = typeof global !== 'undefined' ? global : typeof self !== 'undefined' ? self : typeof window !== 'undefined' ? window : {}, document = window.document || {},
(function (a, b) {
  typeof require === 'function' && typeof exports === 'object' && typeof module === 'object' ? a(require('jquery')) : typeof define === 'function' && define.amd ? define(['jquery'], a) : a(b.jQuery);
}((a) => {
  let b = 0;
  const c = {};
  const d = {};
  let e = window.emojione;
  const f = [];

  function g(a) {
    e ? a() : f.push(a);
  }
  const h = 'data:image/gif;base64,R0lGODlhAQABAJH/AP///wAAAMDAwAAAACH5BAEAAAIALAAAAAABAAEAAAICVAEAOw==';
  const i = [].slice;
  const j = 'emojionearea';
  let k = 0;
  const l = '&#8203;';
  ...
  function m(b, d, e) {
    ...
    if (d) {
      ...
      do {
        const h = g == 1 ? `@${d}` : d;
        c[b.id][h] && c[b.id][h].length && a.each(c[b.id][h], (a, c) => f = c.apply(b, e || []) !== !1);
      } while (f && g--);
    }
    return f;
  }
  ...
  function o(a, b, c) {
    const d = e.imageType;
    let f;
    f = d == 'svg' ? e.imagePathSVG : e.imagePathPNG;
    let g = '';
    c && (g = c.substr(1, c.length - 2).replace(/_/g, ' ').replace(/\w\S*/g, (a) => a.charAt(0).toUpperCase() + a.substr(1).toLowerCase()));
    let h = '';
    return b.uc_base && k > 4 ? (h = b.uc_base, b = b.uc_output.toUpperCase()) : h = b, a.replace('{name}', c || '').replace('{friendlyName}', g).replace('{img}', `${f + (k < 2 ? h.toUpperCase() : h)}.${d}`).replace('{uni}', b)
      .replace('{alt}', e.convert(b));
  }

  function p(a, b, c) {
    return a.replace(/:?\+?[\w_\-]+:?/g, (a) => {
      a = `:${a.replace(/:$/, '').replace(/^:/, '')}:`;
      let d = e.emojioneList[a];
  ...
  function q(a) {
    ...
    } else document.selection && document.selection.type != 'Control' && document.selection.createRange().pasteHTML(a);
  }
  ...
  function t(a) {
    let b;
    return a.cacheBustParam ? (b = a.cacheBustParam, s(a.jsEscapeMap) ? b === '?v=1.2.4' ? '2.0.0' : b === '?v=2.0.1' ? '2.1.0' : b === '?v=2.1.1' ? '2.1.1' : b === '?v=2.1.2' ? '2.1.2' : b === '?v=2.1.3' ? '2.1.3' : b === '?v=2.1.4' ? '2.1.4' : '2.2.7' : '1.5.2') : a.emojiVersion;
  }
  ...
  function v() {
    ...
    return c > 4 ? b.filters = {
      ...
      flags: {
        icon: 'flag_gb',
        title: 'Flags',
        emoji: 'ac af al dz ad ao ai ag ar am aw au at az bs bh bd bb by be bz bj bm bt bo ba bw br bn bg bf bi cv kh cm ca ky cf td flag_cl cn co km cg flag_cd cr hr cu cy cz dk dj dm do ec eg sv gq er ee et fk fo fj fi fr pf ga gm ge de gh gi gr gl gd gu gt gn gw gy ht hn hk hu is in flag_id ir iq ie il it ci jm jp crossed_flags flag_je flag_jo flag_kz flag_ke flag_ki xk kw kg la lv lb ls lr ly li lt lu mo mk mg mw my mv ml mt mh mr mu yt mx fm md mc mn me ms ma mz mm na nr np nl nc nz ni ne flag_ng nu kp no om pk pw ps pa pg py pe ph pl pt pr qa re ro ru rw ws sm st flag_sa sn rs sc sl sg sk si sb so za kr ss es lk sd sr sz se ch sy tw tj tz th tl tg to tt tn tr tm tc tv vi ug ua ae gb us uy uz vu va ve vn wf eh ye zm zw re ax ta io bq cx cc gg im yt nf pn bl pm gs tk bv hm sj um ic ea cp dg as aq vg ck cw eu gf tf gp mq mp sx ss tc ',
      },
    }, b;
  }
  ...
  function w(b) {
    ...
    if (b && b.filters) {
      const d = c.filters;
      a.each(b.filters, (b, c) => (!s(c) || a.isEmptyObject(c) ? void delete d[b] : void a.each(c, (a, c) => {
        d[b][a] = c;
      }))), b.filters = d;
    }
    return a.extend({}, c, b);
  ...
  window.getSelection && document.createRange ? (x = function (a) {
    const b = window.getSelection && window.getSelection();
  ...
  function A(a, b) {
    return a.replace(z, (a) => {
      const c = e[k === 0 ? 'jsecapeMap' : 'jsEscapeMap'];
      return typeof a !== 'undefined' && a in c ? o(b, c[a]) : a;
    });
  }

  function B(a, b) {
    return a = a.replace(/&/g, '&amp;').replace(/</g, '&lt;').replace(/>/g, '&gt;').replace(/"/g, '&quot;')
      .replace(/'/g, '&#x27;')
      .replace(/`/g, '&#x60;')
      .replace(/(?:\r\n|\r|\n)/g, '\n')
      .replace(/(\n+)/g, '<div>$1</div>')
      .replace(/\n/g, '<br/>')
      .replace(/<br\/><\/div>/g, '</div>'), b.shortnames && (a = e.shortnameToUnicode(a)), A(a, b.emojiTemplate).replace(/\t/g, '&nbsp;&nbsp;&nbsp;&nbsp;').replace(/ {2}/g, '&nbsp;&nbsp;');
  }
  ...
  function D() {
    const a = this;
    const b = a.editor[0].offsetWidth - a.editor[0].clientWidth;
    const c = parseInt(a.button.css('marginRight'));
    c !== b && (a.button.css({
      marginRight: b,
  ...
  function E() {
    ...
    if (!b.sprite && b.lasyEmoji[0] && b.lasyEmoji.eq(0).is('.lazy-emoji')) {
      const c = b.picker.offset().top;
      const d = c + b.picker.height() + 20;
      b.lasyEmoji.each(function () {
        const b = a(this);
        const e = b.offset().top;
  ...
  function G(b) {
    ...
    return a.each(i.call(arguments).slice(1), (b, d) => {
    ...
    if (!b.recent || b.recent !== d || c) {
      if (d.length) {
        ...
        if (b.recentCategory.children('.emojibtn').remove(), a(h).insertAfter(b.recentCategory.children('.emojionearea-category-title')), b.recentCategory.children('.emojibtn').on('click', function () {
          ...
          const i = b.recentCategory.height();
  ...
  function L(b, c, d) {
    b.options = d = w(d), b.sprite = d.sprite && k < 3, b.inline = d.inline === null ? c.is('INPUT') : d.inline, b.shortnames = d.shortnames, b.saveEmojisAs = d.saveEmojisAs, b.standalone = d.standalone, b.emojiTemplate = `<img alt="{alt}" class="emojione${b.sprite ? `-{uni}" src="${h}"/>` : 'emoji" src="{img}"/>'}`, b.emojiTemplateAlt = b.sprite ? '<i class="emojione-{uni}"/>' : '<img class="emojioneemoji" src="{img}"/>', b.emojiBtnTemplate = `<i class="emojibtn" role="button" data-name="{name}" title="{friendlyName}">${b.emojiTemplateAlt}</i>`, b.recentEmojis = d.recentEmojis && K();
    const f = d.pickerPosition;
    b.floatingPicker = f === 'top' || f === 'bottom', b.source = c, (c.is(':disabled') || c.is('.disabled')) && b.disable();
    const g = c.is('TEXTAREA') || c.is('INPUT') ? 'val' : 'text';
    let i;
    let o;
    let r;
    let t;
    ...
    let L;
    let M;
    const N = G('tones', d.tones ? function () {
    ...
    } : null), N) : null, M = G('scroll-area', d.tones && !d.search ? G('tones-panel', N) : null, z = G('emojis-list')))).addClass(F(`picker-position-${d.pickerPosition}`, !0)).addClass(F(`filters-position-${d.filtersPosition}`, !0)).addClass(F(`search-position-${d.searchPosition}`, !0))
      .addClass('hidden'));
    d.search && v.addClass(F('with-search', !0)), b.searchSel = null, i.data(c.data()), a.each(d.attributes, (a, b) => {
      i.attr(a, b);
    });
    const P = G('category-block').attr({
      'data-tone': 0,
    }).prependTo(z);
    if (a.each(d.filters, (c, e) => {
      let f = 0;
      if (c !== 'recent' || b.recentEmojis) {
        if (c !== 'tones') {
          a('<i/>', {
        ...
        do {
          ...
          g = f === 0 ? G('category').attr({
            name: c,
            'data-tone': f,
          }).appendTo(P) : G('category-block').attr({
            name: c,
            'data-tone': f,
          }).appendTo(z), f > 0 && (g.hide(), h = `${h.split('|').join(`_tone${f}|`)}_tone${f}`), c === 'recent' && (h = H()), h = p(h, b.sprite ? '<i class="emojibtn" role="button" data-name="{name}" title="{friendlyName}"><i class="emojione-{uni}"></i></i>' : '<i class="emojibtn" role="button" data-name="{name}" title="{friendlyName}"><img class="emojioneemoji lazy-emoji" data-src="{img}"/></i>', !0).split('|').join(''), g.html(h), a('<div class="emojionearea-category-title"/>').text(e.title).prependTo(g);
        } while (--f > 0);
      }
      ...
      const Q = a(c).data('emoji-placeholder') || d.emojiPlaceholder;
    ...
    n(b, z.find('.emojibtn'), {
      ...
      paste: '!paste',
    }, i), n(b, i, ['focus', 'blur'], () => !b.stayFocused && i), n(b, r, {
    ...
    if (M.on('scroll', () => {
      if (!R && (E.call(b), M.is(':not(.skinnable)'))) {
        let c = A.eq(0);
        const d = M.offset().top;
        A.each((b, e) => !(a(e).offset().top - d >= 10) && void (c = a(e)));
        const e = u.filter(`[data-filter="${c.attr('name')}"]`);
      ...
      const d = A.filter(`[name="${a.data('filter')}"]`).offset().top;
      const e = M.scrollTop();
      const f = M.offset().top;
      M.stop().animate({
        scrollTop: d + e - f - 2,
      }, 200, 'swing', () => {
        E.call(b), R = !1;
      ...
      const c = a.addClass('active').data('skin');
      ...
      .on('@!paste', (c, d) => {
        ...
        window.setTimeout(() => {
          c.focus(), y(c[0], g);
          const a = C(i.html().replace(/\r\n|\n|\r/g, '<br>'), b);
          i.remove(), e(a);
        }, 200);
      })
      .on('@emojibtn.click', (a) => {
        i.removeClass('has-placeholder'), b.searchSel !== null && (i.focus(), y(i[0], b.searchSel), b.searchSel = null), b.standalone ? (i.html(p(a.data('name'), b.emojiTemplate)), b.trigger('blur')) : (x(i[0]), q(p(a.data('name'), b.emojiTemplate))), b.recentEmojis && J(b, a.data('name')), b.trigger('search.keypress');
      })
      .on('@!resize @keyup @emojibtn.click', D)
      .on('@!mousedown', (c, d) => (a(d.target).hasClass('search') ? (b.stayFocused = !0, b.searchSel === null && (b.searchSel = x(c[0]))) : (O.is('.focused') || c.trigger('focus'), d.preventDefault()), !1))
      .on('@change', () => {
        const a = b.editor.html().replace(/<\/?(?:div|span|p)[^>]*>/gi, '');
      ...
      }), d.search && b.on('@search.focus', () => {
      b.stayFocused = !0, b.search.addClass('focused');
    }).on('@search.keypress', (c) => {
      const e = r.find('.emojionearea-filter');
      const f = d.tones ? N.find('i.active').data('skin') : 0;
      const g = b.search.val().replace(/ /g, '_').replace(/"/g, '\\"');
      g && g.length ? (b.recentFilter.hasClass('active') && b.recentFilter.removeClass('active').next().addClass('active'), b.recentCategory.hide(), b.recentFilter.hide(), L.each(function () {
        const b = function (a, b) {
          const c = a.find(`.emojibtn[data-name*="${g}"]`);
          if (c.length === 0) a.data('tone') === b && a.hide(), e.filter(`[data-filter="${a.attr('name')}"]`).hide();
          else {
            const d = a.find(`.emojibtn:not([data-name*="${g}"])`);
            d.hide(), c.show(), a.data('tone') === b && a.show(), e.filter(`[data-filter="${a.attr('name')}"]`).show();
          }
        };
        const c = a(this);
        c.data('tone') === 0 ? A.filter(':not([name="recent"])').each(function () {
          b(a(this), 0);
        }) : b(c, f);
    ...
    }), d.shortcuts && b.on('@keydown', (a, c) => {
      c.ctrlKey || (c.which == 9 ? (c.preventDefault(), o.click()) : c.which == 27 && (c.preventDefault(), o.is('.active') && b.hidePicker()));
    }), s(d.events) && !a.isEmptyObject(d.events) && a.each(d.events, (a, c) => {
      ...
      const S = function () {
        ...
        d.shortcuts && (c.onKeydown = function (a, b) {
          if (!a.ctrlKey && a.which == 13) return b.KEY_ENTER;
        });
        const f = a.map(e.emojioneList, (a, b) => (d.autocompleteTones ? b : /_tone[12345]/.test(b) ? null : b));
        f.sort(), i.textcomplete([{
          id: j,
          match: /\B(:[\-+\w]*)$/,
          search(b, c) {
            c(a.map(f, (a) => (a.indexOf(b) === 0 ? a : null)));
          },
          template(a) {
          ...
          cache: !0,
          index: 1,
        }], c), d.textcomplete.placement && a(i.data('textComplete').option.appendTo).css('position') == 'static' && a(i.data('textComplete').option.appendTo).css('position', 'relative');
      };
      const T = function () {
        if (b.disabled) {
          var a = function () {
    ...
    b.inline && (O.addClass(F('inline', !0)), b.on('@keydown', (a, b) => {
  ...
  const M = {
    ...
    base: '/home/ArriveWoo/try.arrivewhats.com/wp-content/plugins/arrivewhats/assets/js/resources',
    isLoading: false,
  };
  ...
  function P(b, c) {
    c = c.replace(/^@/, '');
    const e = b.id;
    d[e][c] && (a.each(d[e][c], (d, e) => {
      a.each(a.isArray(e[0]) ? e[0] : [e[0]], (d, f) => {
        a(f).on(e[1], function () {
          const d = i.call(arguments);
          const f = a.isFunction(e[2]) ? e[2].apply(b, [c].concat(d)) : e[2];
          f && m(b, c, [f].concat(d));
        });
      });
    }), d[e][c] = null);
  ...
  O.prototype.on = function (b, d) {
    if (b && a.isFunction(d)) {
      const e = this;
      a.each(b.toLowerCase().split(' '), (a, b) => {
    ...
    if (b) {
      const e = this.id;
      a.each(b.toLowerCase().replace(/_/g, '.').split(' '), (b, f) => {
        c[e][f] && !/^@/.test(f) && (d ? a.each(c[e][f], (a, b) => {
    ...
    const b = [this].concat(a.slice(0, 1));
    ...
    const a = this;
    return a._sh_timer && window.clearTimeout(a._sh_timer), a.picker.removeClass('hidden'), a._sh_timer = window.setTimeout(() => {
      a.button.addClass('active');
    }, 50), m(a, 'picker.show', [a.picker]), a;
  }, O.prototype.hidePicker = function () {
    const a = this;
    return a._sh_timer && window.clearTimeout(a._sh_timer), a.button.removeClass('active'), a._sh_timer = window.setTimeout(() => {
    ...
    const b = function () {
      ...
      const b = a[a.standalone ? 'button' : 'editor'];
    ...
    const c = this;
    const d = {
      shortnames: !b || typeof b.shortnames === 'undefined' || b.shortnames,
